...
int main() {
    ...
    printf("=== RAW SOCKET: ЗАДАНИЕ 1 ===\n");
    printf("Клиент формирует ТОЛЬКО UDP заголовок + данные\n\n");
    ...
    strcpy(data, "Hello from Task 1: UDP header only!");
    ...
    pseudo.src_addr = inet_addr("127.0.0.1");
    pseudo.dst_addr = inet_addr("127.0.0.1");
    pseudo.zero = 0;
    ...
    packet_size = sizeof(struct udphdr) + strlen(data) + 1;
    
    printf("Сформирован UDP пакет:\n");
